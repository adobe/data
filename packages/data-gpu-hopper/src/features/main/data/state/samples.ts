...
// against the store the ecs re-materialises, which mints its own entity ids — so a
// sample's hazard-entity keys are plain spec-ids that conformance compares up to an
// id-bijection (see conformance.md).
