...
declare global {
    interface HTMLElementTagNameMap {
        [tagName]: MetalRoughSpheresElement;
    }
}
...
export class MetalRoughSpheresElement extends DatabaseElement<typeof pbrModelIblPlugin> {
    static styles = css`
        :host { display: block; }
    ...
    override render() {
        ...
        useEffect(() => {
            ...
            service.transactions.initializeScene({
                ...
                envUrl: ENV_URL,
                lightColor: [0, 0, 0],
                orbitFit: { radiusFactor: 1.2, heightFactor: 0 },
            });
        }, [canvas, service]);
