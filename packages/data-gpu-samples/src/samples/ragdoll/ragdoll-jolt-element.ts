...
import { ragdollJoltPlugin } from "./ragdoll-service.js";
import { useOrbitCameraControl } from "../../hooks/use-orbit-camera-control.js";

const tagName = "ragdoll-jolt";

declare global {
    interface HTMLElementTagNameMap {
        [tagName]: RagdollJoltElement;
    }
}
...
export class RagdollJoltElement extends DatabaseElement<typeof ragdollJoltPlugin> {
    static styles = css`
        :host { display: block; }
    ...
    get plugin() { return ragdollJoltPlugin; }
    ...
    override render() {
        ...
        return html`
            <div class="stage">
                ...
                <div class="hint">Jolt · cone-limit ragdoll · drag to orbit</div>
            </div>
        `;
    }
}
