...
import { ragdollRapierPlugin } from "./ragdoll-service.js";
import { useOrbitCameraControl } from "../../hooks/use-orbit-camera-control.js";

const tagName = "ragdoll-rapier";

declare global {
    interface HTMLElementTagNameMap {
        [tagName]: RagdollRapierElement;
    }
}
...
export class RagdollRapierElement extends DatabaseElement<typeof ragdollRapierPlugin> {
    static styles = css`
        :host { display: block; }
    ...
    get plugin() { return ragdollRapierPlugin; }
    ...
    override render() {
        ...
        return html`
            <div class="stage">
                ...
                <div class="hint">Rapier · free-ball ragdoll · drag to orbit</div>
            </div>
        `;
    }
}
