...
import { rigidStackJoltPlugin } from "./rigid-stack-service.js";
import { useOrbitCameraControl } from "../../hooks/use-orbit-camera-control.js";

const tagName = "rigid-stack-jolt";

declare global {
    interface HTMLElementTagNameMap {
        [tagName]: RigidStackJoltElement;
    }
}

/** Same scene + render path as the CPU element, driven by the Jolt solver plugin. */
@customElement(tagName)
export class RigidStackJoltElement extends DatabaseElement<typeof rigidStackJoltPlugin> {
    static styles = css`
        :host { display: block; }
    ...
    get plugin() { return rigidStackJoltPlugin; }
