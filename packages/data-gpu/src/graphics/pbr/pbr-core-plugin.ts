 ...
 * producer plus a renderer aggregator (`pbrIblRender` or `pbrDirectRender`)
 * to get drawable scenes.
 */
export const pbrCore = Database.Plugin.create({
    components: {
        _vertexBuffer:                  { default: null as unknown as GPUBuffer },
        ...
        _indexBuffer:                   { default: null as unknown as GPUBuffer },
        _indexCount:                    U32.schema,
        _indexFormat:                   { default: "uint16" as GPUIndexFormat },
        _materialBindGroup:             { default: null as unknown as GPUBindGroup },
