...
import type { ColorMaterialOptions } from "../../../rendering/visible-material/color-material-options.js";
...
export function createColorMaterial(
    ...
    const material: VisibleMaterial = {
    ...
    const structBuffer = createStructBuffer(visibleMaterialSchema, layout.size);
