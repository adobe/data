...
// The assembled asteroids feature database, feature-qualified for external
...
export { FeatureDatabase as AsteroidsDatabase } from "./features/main/ecs/feature-database.js";
