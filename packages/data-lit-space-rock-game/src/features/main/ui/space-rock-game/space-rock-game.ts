 ...
 */
export const SpaceRockGame = <S extends SystemDatabase>(args: { service: S }): TemplateResult => {
  void import("./space-rock-game-element.js");
  return html`<space-rock-game .service=${args.service}></space-rock-game>`;
};
