...
// The core schema: all components, resources, and archetypes for the feature,
// grouped by scope inside components.ts / resources.ts. tictactoe is
// document-only (shared + durable) — no settings/presence/session state.
