...
// persistent model. Archetypes live here because they are a physical packing
// convenience — not part of the serialized data model. Any component or
// resource added at this layer must be marked `nonPersistent: true`.
