...
// The feature's composition root. This is the plugin a feature UI element
// lazily extends the shared (main) database with on first connect — adding the
// User archetype, both indexes, the transactions, and the computed at once.
