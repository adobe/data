...
//     value that differs only by F32↔f64 storage rounding (rotation / position
//     are F32 in the ecs, the spec authors plain numbers) compares equal.
//     `Math.fround` collapses the F32 rounding; rounding to 1e-2 collapses any
//     residue. `+ 0` normalises `-0` to `0`.
