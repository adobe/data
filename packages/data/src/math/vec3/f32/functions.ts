...
export const zero: F32 = [0, 0, 0];
export const one: F32 = [1, 1, 1];

// Mathematical Operations
export const abs = ([x, y, z]: F32): F32 => [Math.abs(x), Math.abs(y), Math.abs(z)];
...
export const round = ([x, y, z]: F32): F32 => [Math.round(x), Math.round(y), Math.round(z)];
...
// Geometric Functions
export const lengthSquared = ([x, y, z]: F32): number => x * x + y * y + z * z;
...
export const dot = ([x1, y1, z1]: F32, [x2, y2, z2]: F32): number =>
    x1 * x2 + y1 * y2 + z1 * z2;
...
export const sin = ([x, y, z]: F32): F32 => [Math.sin(x), Math.sin(y), Math.sin(z)];
export const cos = ([x, y, z]: F32): F32 => [Math.cos(x), Math.cos(y), Math.cos(z)];
export const tan = ([x, y, z]: F32): F32 => [Math.tan(x), Math.tan(y), Math.tan(z)];
export const asin = ([x, y, z]: F32): F32 => [Math.asin(x), Math.asin(y), Math.asin(z)];
export const acos = ([x, y, z]: F32): F32 => [Math.acos(x), Math.acos(y), Math.acos(z)];
export const atan = ([x, y, z]: F32): F32 => [Math.atan(x), Math.atan(y), Math.atan(z)];
...
export const acosh = ([x, y, z]: F32): F32 => [Math.acosh(x), Math.acosh(y), Math.acosh(z)];
export const atanh = ([x, y, z]: F32): F32 => [Math.atanh(x), Math.atanh(y), Math.atanh(z)];

// Common Functions
export const sign = ([x, y, z]: F32): F32 => [Math.sign(x), Math.sign(y), Math.sign(z)];
export const fract = ([x, y, z]: F32): F32 => [
    x - Math.floor(x),
    y - Math.floor(y),
    z - Math.floor(z)
];
export const mod = ([x, y, z]: F32, m: number): F32 => [
    ((x % m) + m) % m,
    ((y % m) + m) % m,
    ((z % m) + m) % m
];
...
export const pow = ([x1, y1, z1]: F32, [x2, y2, z2]: F32): F32 => [
    Math.pow(x1, x2),
    Math.pow(y1, y2),
    Math.pow(z1, z2)
];
...
export const log2 = ([x, y, z]: F32): F32 => [Math.log2(x), Math.log2(y), Math.log2(z)];
export const sqrt = ([x, y, z]: F32): F32 => [Math.sqrt(x), Math.sqrt(y), Math.sqrt(z)];

// Helper functions needed by some of the above
export const add = ([x1, y1, z1]: F32, [x2, y2, z2]: F32): F32 => [
    x1 + x2,
    y1 + y2,
    z1 + z2
];
export const subtract = ([x1, y1, z1]: F32, [x2, y2, z2]: F32): F32 => [
    x1 - x2,
    y1 - y2,
    z1 - z2
];
...
export const scale = ([x, y, z]: F32, s: number): F32 => [x * s, y * s, z * s];
export const negate = ([x, y, z]: F32): F32 => [-x, -y, -z];
